...
import { AlexisHrCustom } from "./client-custom";

export class AlexisHr extends AlexisHrCustom {
  readonly child: ChildApi;
  ...
  readonly employeeTeamReference: EmployeeTeamReferenceApi;
  readonly employment: EmploymentApi;
  readonly employmentType: EmploymentTypeApi;
  readonly leave: LeaveApi;
  readonly leaveTransaction: LeaveTransactionApi;
  readonly leaveType: LeaveTypeApi;
  readonly office: OfficeApi;
  readonly team: TeamApi;
  readonly timesheet: TimesheetApi;
  readonly timesheetEntry: TimesheetEntryApi;
  readonly timesheetEntryType: TimesheetEntryTypeApi;
  readonly workWeek: WorkWeekApi;

  constructor(configurationParameters: ConfigurationParameters) {
    super(configurationParameters);
    const configuration = new Configuration(configurationParameters);
    this.child = new ChildApi(configuration);
    ...
    this.employeeTeamReference = new EmployeeTeamReferenceApi(configuration);
    this.employment = new EmploymentApi(configuration);
    this.employmentType = new EmploymentTypeApi(configuration);
    this.leave = new LeaveApi(configuration);
    this.leaveTransaction = new LeaveTransactionApi(configuration);
    this.leaveType = new LeaveTypeApi(configuration);
    this.office = new OfficeApi(configuration);
    this.team = new TeamApi(configuration);
    this.timesheet = new TimesheetApi(configuration);
    this.timesheetEntry = new TimesheetEntryApi(configuration);
    this.timesheetEntryType = new TimesheetEntryTypeApi(configuration);
    this.workWeek = new WorkWeekApi(configuration);
  }
