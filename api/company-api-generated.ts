...
// @ts-ignore
import { CompaniesGetManyResponseMapped } from '../models';
// @ts-ignore
import { CompanyGetOneResponseMapped } from '../models';
// @ts-ignore
import { CompanyListManyCompaniesFiltersParameter } from '../models';
// @ts-ignore
import { CompanyListManyCompaniesSortParameter } from '../models';
// @ts-ignore
...
export const CompanyApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {Array<'id'>} [select] Select Company fields, comma-separated. (e.g. &#x60;select&#x3D;id,firstName,lastName,workEmail&#x60;)
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getOne: async (id: string, select?: Array<'id'>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @param {Array<'id'>} [select] Select Company fields, comma-separated. (e.g. &#x60;select&#x3D;id,firstName,lastName,workEmail&#x60;)
         * @param {CompanyListManyCompaniesFiltersParameter} [filters] Filters conditions per field. (e.g. &#x60;filters[id][$eq]&#x3D;507f1f77bcf86cd799439011&#x60;)
         * @param {number} [limit] Limit amount of received Companies. (e.g. &#x60;limit&#x3D;20&#x60;)
         * @param {number} [offset] Offset amount of received Companies. (e.g. &#x60;offset&#x3D;20&#x60;)
         * @param {CompanyListManyCompaniesSortParameter} [sort] Sort received Companies by field. (e.g. &#x60;sort[id]&#x3D;asc&#x60;)
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        listManyCompanies: async (select?: Array<'id'>, filters?: CompanyListManyCompaniesFiltersParameter, limit?: number, offset?: number, sort?: CompanyListManyCompaniesSortParameter, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const CompanyApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Get One Company
         * @summary Get One Company
         * @param {CompanyApiGetOneRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getOne(requestParameters: CompanyApiGetOneRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CompanyGetOneResponseMapped>> {
         ...
         * Get Many Companies
         * @summary Get Many Companies
         * @param {CompanyApiListManyCompaniesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async listManyCompanies(requestParameters: CompanyApiListManyCompaniesRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CompaniesGetManyResponseMapped>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listManyCompanies(requestParameters.select, requestParameters.filters, requestParameters.limit, requestParameters.offset, requestParameters.sort, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const CompanyApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getOne(requestParameters: CompanyApiGetOneRequest, options?: AxiosRequestConfig): AxiosPromise<CompanyGetOneResponseMapped> {
         ...
         * @throws {RequiredError}
         */
        listManyCompanies(requestParameters: CompanyApiListManyCompaniesRequest, options?: AxiosRequestConfig): AxiosPromise<CompaniesGetManyResponseMapped> {
            return localVarFp.listManyCompanies(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for getOne operation in CompanyApi.
 * @export
 * @interface CompanyApiGetOneRequest
 */
export type CompanyApiGetOneRequest = {
    
    /**
    * Resource Id
    * @type {string}
    * @memberof CompanyApiGetOne
    */
    readonly id: string
...
/**
 * Request parameters for listManyCompanies operation in CompanyApi.
 * @export
 * @interface CompanyApiListManyCompaniesRequest
 */
export type CompanyApiListManyCompaniesRequest = {
    
    /**
    * Select Company fields, comma-separated. (e.g. `select=id,firstName,lastName,workEmail`)
    * @type {Array<'id'>}
    * @memberof CompanyApiListManyCompanies
    */
    readonly select?: Array<'id'>
    
    /**
    * Filters conditions per field. (e.g. `filters[id][$eq]=507f1f77bcf86cd799439011`)
    * @type {CompanyListManyCompaniesFiltersParameter}
    * @memberof CompanyApiListManyCompanies
    */
    readonly filters?: CompanyListManyCompaniesFiltersParameter
    ...
    * @type {CompanyListManyCompaniesSortParameter}
    * @memberof CompanyApiListManyCompanies
    */
    readonly sort?: CompanyListManyCompaniesSortParameter
...
export class CompanyApiGenerated extends BaseAPI {
     ...
     */
    public getOne(requestParameters: CompanyApiGetOneRequest, options?: AxiosRequestConfig) {
        return CompanyApiFp(this.configuration).getOne(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CompanyApiGenerated
     */
    public listManyCompanies(requestParameters: CompanyApiListManyCompaniesRequest, options?: AxiosRequestConfig) {
        return CompanyApiFp(this.configuration).listManyCompanies(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
