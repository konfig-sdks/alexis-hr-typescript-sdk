...
import { EmployeeGetOneRelationsResponse } from './employee-get-one-relations-response';
import { EmployeeResponse } from './employee-response';

/**
 * 
 * @export
 * @interface EmployeeGetOneResponseMapped
 */
export interface EmployeeGetOneResponseMapped {
    /**
     * Status String
     * @type {string}
     * @memberof EmployeeGetOneResponseMapped
     */
    'status': string;
    /**
     * Resource data
    ...
    /**
     * Resource relations
     * @type {EmployeeGetOneRelationsResponse}
     * @memberof EmployeeGetOneResponseMapped
     */
    'relations'?: EmployeeGetOneRelationsResponse;
}
