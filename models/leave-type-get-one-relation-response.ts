 ...
 * 
 * @export
 * @interface LeaveTypeGetOneRelationResponse
 */
export interface LeaveTypeGetOneRelationResponse {
    /**
     * 
     * @type {LeaveTypeCodeResponse}
     * @memberof LeaveTypeGetOneRelationResponse
     */
    'leaveTypeCode'?: LeaveTypeCodeResponse;
}
