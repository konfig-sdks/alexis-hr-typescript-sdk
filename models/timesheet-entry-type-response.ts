 ...
 * 
 * @export
 * @interface TimesheetEntryTypeResponse
 */
export interface TimesheetEntryTypeResponse {
    /**
     * 
     * @type {string}
     * @memberof TimesheetEntryTypeResponse
     */
    'id': string;
    /**
     * 
     ...
     * @memberof TimesheetEntryTypeResponse
     */
    'kind'?: TimesheetEntryTypeResponseKindEnum;
}

type TimesheetEntryTypeResponseKindEnum = 'HOURLY_WAGE' | 'WORKING_HOURS'
