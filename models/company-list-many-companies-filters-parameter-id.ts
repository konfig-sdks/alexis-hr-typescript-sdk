 ...
 * 
 * @export
 * @interface CompanyListManyCompaniesFiltersParameterId
 */
export interface CompanyListManyCompaniesFiltersParameterId {
    /**
     * 
     * @type {string}
     * @memberof CompanyListManyCompaniesFiltersParameterId
     */
    '$eq'?: string;
    /**
     * 
