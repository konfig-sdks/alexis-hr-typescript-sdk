 ...
 * 
 * @export
 * @interface TeamListTeamsSortParameter
 */
export interface TeamListTeamsSortParameter {
    /**
     * 
     * @type {string}
     * @memberof TeamListTeamsSortParameter
     */
    'description'?: TeamListTeamsSortParameterDescriptionEnum;
    /**
     * 
     * @type {string}
     * @memberof TeamListTeamsSortParameter
     */
    'id'?: TeamListTeamsSortParameterIdEnum;
    /**
     * 
     * @type {string}
     * @memberof TeamListTeamsSortParameter
     */
    'companyId'?: TeamListTeamsSortParameterCompanyIdEnum;
    /**
     * 
     * @type {string}
     * @memberof TeamListTeamsSortParameter
     */
    'name'?: TeamListTeamsSortParameterNameEnum;
    /**
     * 
     * @type {string}
     * @memberof TeamListTeamsSortParameter
     */
    'bgColor'?: TeamListTeamsSortParameterBgColorEnum;
    /**
     * 
     * @type {string}
     * @memberof TeamListTeamsSortParameter
     */
    'fgColor'?: TeamListTeamsSortParameterFgColorEnum;
}

type TeamListTeamsSortParameterDescriptionEnum = 'asc' | 'desc'
type TeamListTeamsSortParameterIdEnum = 'asc' | 'desc'
type TeamListTeamsSortParameterCompanyIdEnum = 'asc' | 'desc'
type TeamListTeamsSortParameterNameEnum = 'asc' | 'desc'
type TeamListTeamsSortParameterBgColorEnum = 'asc' | 'desc'
type TeamListTeamsSortParameterFgColorEnum = 'asc' | 'desc'
