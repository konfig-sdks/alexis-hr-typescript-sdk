...
import { LeaveTypeGetManyRelationsResponse } from './leave-type-get-many-relations-response';
import { LeaveTypeResponse } from './leave-type-response';

/**
 * 
 * @export
 * @interface LeaveTypesGetManyResponseMapped
 */
export interface LeaveTypesGetManyResponseMapped {
    /**
     * Status String
     * @type {string}
     * @memberof LeaveTypesGetManyResponseMapped
     */
    'status': string;
    /**
     * Resource data
     * @type {Array<LeaveTypeResponse>}
     * @memberof LeaveTypesGetManyResponseMapped
     */
    'data': Array<LeaveTypeResponse>;
    /**
    ...
    /**
     * Resource relations
     * @type {LeaveTypeGetManyRelationsResponse}
     * @memberof LeaveTypesGetManyResponseMapped
     */
    'relations'?: LeaveTypeGetManyRelationsResponse;
}
