 ...
 * 
 * @export
 * @interface ChildGetManySortParameter
 */
export interface ChildGetManySortParameter {
    /**
     * 
     * @type {string}
     * @memberof ChildGetManySortParameter
     */
    'id'?: ChildGetManySortParameterIdEnum;
    /**
     * 
     * @type {string}
     * @memberof ChildGetManySortParameter
     */
    'employeeId'?: ChildGetManySortParameterEmployeeIdEnum;
    /**
     * 
     * @type {string}
     * @memberof ChildGetManySortParameter
     */
    'name'?: ChildGetManySortParameterNameEnum;
    /**
     * 
     * @type {string}
     * @memberof ChildGetManySortParameter
     */
    'birthdate'?: ChildGetManySortParameterBirthdateEnum;
}

type ChildGetManySortParameterIdEnum = 'asc' | 'desc'
type ChildGetManySortParameterEmployeeIdEnum = 'asc' | 'desc'
type ChildGetManySortParameterNameEnum = 'asc' | 'desc'
type ChildGetManySortParameterBirthdateEnum = 'asc' | 'desc'
