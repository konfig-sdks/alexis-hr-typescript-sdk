 ...
 * 
 * @export
 * @interface UpdateEmploymentRequest
 */
export interface UpdateEmploymentRequest {
    /**
     * 
     * @type {string}
     * @memberof UpdateEmploymentRequest
     */
    'employeeId'?: string;
    /**
     * 
