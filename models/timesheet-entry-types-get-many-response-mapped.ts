 ...
 * 
 * @export
 * @interface TimesheetEntryTypesGetManyResponseMapped
 */
export interface TimesheetEntryTypesGetManyResponseMapped {
    /**
     * Status String
     * @type {string}
     * @memberof TimesheetEntryTypesGetManyResponseMapped
     */
    'status': string;
    /**
     * Resource data
     ...
     * @memberof TimesheetEntryTypesGetManyResponseMapped
     */
    'data': Array<TimesheetEntryTypeResponse>;
    /**
