...
import { TimesheetRelationsResponse } from './timesheet-relations-response';
import { TimesheetResponse } from './timesheet-response';

/**
 * 
 * @export
 * @interface TimesheetsGetManyResponseMapped
 */
export interface TimesheetsGetManyResponseMapped {
    /**
     * Status String
     * @type {string}
     * @memberof TimesheetsGetManyResponseMapped
     */
    'status': string;
    /**
     * Resource data
    ...
    /**
     * Resource relations
     * @type {TimesheetRelationsResponse}
     * @memberof TimesheetsGetManyResponseMapped
     */
    'relations'?: TimesheetRelationsResponse;
}
