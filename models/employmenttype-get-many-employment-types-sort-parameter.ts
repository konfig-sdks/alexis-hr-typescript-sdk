 ...
 * 
 * @export
 * @interface EmploymenttypeGetManyEmploymentTypesSortParameter
 */
export interface EmploymenttypeGetManyEmploymentTypesSortParameter {
    /**
     * 
     * @type {string}
     * @memberof EmploymenttypeGetManyEmploymentTypesSortParameter
     */
    'id'?: EmploymenttypeGetManyEmploymentTypesSortParameterIdEnum;
    /**
     * 
     * @type {string}
     * @memberof EmploymenttypeGetManyEmploymentTypesSortParameter
     */
    'companyId'?: EmploymenttypeGetManyEmploymentTypesSortParameterCompanyIdEnum;
    /**
     * 
     * @type {string}
     * @memberof EmploymenttypeGetManyEmploymentTypesSortParameter
     */
    'name'?: EmploymenttypeGetManyEmploymentTypesSortParameterNameEnum;
    /**
     * 
     * @type {string}
     * @memberof EmploymenttypeGetManyEmploymentTypesSortParameter
     */
    'vacation'?: EmploymenttypeGetManyEmploymentTypesSortParameterVacationEnum;
    /**
     * 
     * @type {string}
     * @memberof EmploymenttypeGetManyEmploymentTypesSortParameter
     */
    'country'?: EmploymenttypeGetManyEmploymentTypesSortParameterCountryEnum;
    /**
     * 
     * @type {string}
     * @memberof EmploymenttypeGetManyEmploymentTypesSortParameter
     */
    'maxMonths'?: EmploymenttypeGetManyEmploymentTypesSortParameterMaxMonthsEnum;
}

type EmploymenttypeGetManyEmploymentTypesSortParameterIdEnum = 'asc' | 'desc'
type EmploymenttypeGetManyEmploymentTypesSortParameterCompanyIdEnum = 'asc' | 'desc'
type EmploymenttypeGetManyEmploymentTypesSortParameterNameEnum = 'asc' | 'desc'
type EmploymenttypeGetManyEmploymentTypesSortParameterVacationEnum = 'asc' | 'desc'
type EmploymenttypeGetManyEmploymentTypesSortParameterCountryEnum = 'asc' | 'desc'
type EmploymenttypeGetManyEmploymentTypesSortParameterMaxMonthsEnum = 'asc' | 'desc'
