 ...
 * 
 * @export
 * @interface WorkWeekGetOneResponseMapped
 */
export interface WorkWeekGetOneResponseMapped {
    /**
     * Status String
     * @type {string}
     * @memberof WorkWeekGetOneResponseMapped
     */
    'status': string;
    /**
     * Resource data
     * @type {WorkWeekResponse}
     * @memberof WorkWeekGetOneResponseMapped
     */
    'data': WorkWeekResponse;
    /**
     * Resource relations
