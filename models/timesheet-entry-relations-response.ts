...
import { TimesheetEntryTypeResponse } from './timesheet-entry-type-response';
import { TimesheetResponse } from './timesheet-response';

/**
 * 
 * @export
 * @interface TimesheetEntryRelationsResponse
 */
export interface TimesheetEntryRelationsResponse {
    /**
     * 
     * @type {Array<EmployeeResponse>}
     * @memberof TimesheetEntryRelationsResponse
     */
    'employee'?: Array<EmployeeResponse>;
    /**
     * 
     * @type {Array<TimesheetResponse>}
     * @memberof TimesheetEntryRelationsResponse
     */
    'timesheet'?: Array<TimesheetResponse>;
    /**
     * 
     * @type {Array<TimesheetEntryTypeResponse>}
     * @memberof TimesheetEntryRelationsResponse
     */
    'type'?: Array<TimesheetEntryTypeResponse>;
}
