...
import { LeaveRelationsResponse } from './leave-relations-response';
import { LeaveResponse } from './leave-response';

/**
 * 
 * @export
 * @interface LeavesGetManyResponseMapped
 */
export interface LeavesGetManyResponseMapped {
    /**
     * Status String
     * @type {string}
     * @memberof LeavesGetManyResponseMapped
     */
    'status': string;
    /**
     * Resource data
     * @type {Array<LeaveResponse>}
     * @memberof LeavesGetManyResponseMapped
     */
    'data': Array<LeaveResponse>;
    /**
    ...
    /**
     * Resource relations
     * @type {LeaveRelationsResponse}
     * @memberof LeavesGetManyResponseMapped
     */
    'relations'?: LeaveRelationsResponse;
}
