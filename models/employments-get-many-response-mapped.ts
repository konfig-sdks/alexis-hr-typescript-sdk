...
import { EmploymentRelationsResponse } from './employment-relations-response';
import { EmploymentResponse } from './employment-response';

/**
 * 
 * @export
 * @interface EmploymentsGetManyResponseMapped
 */
export interface EmploymentsGetManyResponseMapped {
    /**
     * Status String
     * @type {string}
     * @memberof EmploymentsGetManyResponseMapped
     */
    'status': string;
    /**
     * Resource data
    ...
    /**
     * Resource relations
     * @type {EmploymentRelationsResponse}
     * @memberof EmploymentsGetManyResponseMapped
     */
    'relations'?: EmploymentRelationsResponse;
}
