...
import { LeaveTypeCodeResponse } from './leave-type-code-response';

/**
 * 
 * @export
 * @interface LeaveTypeGetManyRelationsResponse
 */
export interface LeaveTypeGetManyRelationsResponse {
    /**
     * 
     * @type {Array<LeaveTypeCodeResponse>}
     * @memberof LeaveTypeGetManyRelationsResponse
     */
    'leaveTypeCode'?: Array<LeaveTypeCodeResponse>;
}
