...
export interface TimesheetResponse {
     ...
     * @memberof TimesheetResponse
     */
    'status': TimesheetResponseStatusEnum;
    /**
     * 
     * @type {string}
     * @memberof TimesheetResponse
     ...
     * @memberof TimesheetResponse
     */
    'localCutOffDate': string;
    /**
     * 
     * @type {string}
     * @memberof TimesheetResponse
     */
    'utcCutOffDate': string;
    /**
     * 
     * @type {string}
     * @memberof TimesheetResponse
     */
    'approvalDeadlineDate': string;
    /**
     * 
     * @type {string}
     * @memberof TimesheetResponse
     */
    'interval': TimesheetResponseIntervalEnum;
    /**
     * 
     * @type {string}
     * @memberof TimesheetResponse
...
type TimesheetResponseStatusEnum = 'PENDING' | 'SUBMITTED' | 'APPROVED' | 'REJECTED'
type TimesheetResponseIntervalEnum = 'WEEKLY' | 'MONTHLY'
