...
export interface LeaveTypeResponse {
     ...
     * @memberof LeaveTypeResponse
     */
    'kind': LeaveTypeResponseKindEnum;
    /**
     * 
     * @type {string}
     * @memberof LeaveTypeResponse
     */
    'minimumDuration': LeaveTypeResponseMinimumDurationEnum;
    /**
     * 
     * @type {boolean}
     * @memberof LeaveTypeResponse
...
type LeaveTypeResponseKindEnum = 'SICK_LEAVE' | 'PARENTAL_LEAVE' | 'VACATION' | 'OFF_DUTY' | 'CHILDCARE'
type LeaveTypeResponseMinimumDurationEnum = 'DAY' | 'HALF_DAY' | 'HOUR' | 'MINUTE'
