 ...
 * 
 * @export
 * @interface EmployeeteamreferenceGetManySortParameter
 */
export interface EmployeeteamreferenceGetManySortParameter {
    /**
     * 
     * @type {string}
     * @memberof EmployeeteamreferenceGetManySortParameter
     */
    'id'?: EmployeeteamreferenceGetManySortParameterIdEnum;
    /**
     * 
     * @type {string}
     * @memberof EmployeeteamreferenceGetManySortParameter
     */
    'companyId'?: EmployeeteamreferenceGetManySortParameterCompanyIdEnum;
    /**
     * 
     * @type {string}
     * @memberof EmployeeteamreferenceGetManySortParameter
     */
    'teamId'?: EmployeeteamreferenceGetManySortParameterTeamIdEnum;
    /**
     * 
     * @type {string}
     * @memberof EmployeeteamreferenceGetManySortParameter
     */
    'userId'?: EmployeeteamreferenceGetManySortParameterUserIdEnum;
    /**
     * 
     * @type {string}
     * @memberof EmployeeteamreferenceGetManySortParameter
     */
    'employeeId'?: EmployeeteamreferenceGetManySortParameterEmployeeIdEnum;
}

type EmployeeteamreferenceGetManySortParameterIdEnum = 'asc' | 'desc'
type EmployeeteamreferenceGetManySortParameterCompanyIdEnum = 'asc' | 'desc'
type EmployeeteamreferenceGetManySortParameterTeamIdEnum = 'asc' | 'desc'
type EmployeeteamreferenceGetManySortParameterUserIdEnum = 'asc' | 'desc'
type EmployeeteamreferenceGetManySortParameterEmployeeIdEnum = 'asc' | 'desc'
