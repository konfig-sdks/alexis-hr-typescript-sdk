...
export interface LeaveResponse {
     ...
     * @memberof LeaveResponse
     */
    'status': LeaveResponseStatusEnum;
    /**
     * 
     * @type {string}
     * @memberof LeaveResponse
     */
    'duration': LeaveResponseDurationEnum;
    /**
     * 
     * @type {string}
     * @memberof LeaveResponse
...
type LeaveResponseStatusEnum = 'PENDING' | 'DENIED' | 'CANCELLED' | 'APPROVED' | 'CONFIRMED'
type LeaveResponseDurationEnum = 'minutes' | 'half_day' | 'one_day' | 'longer'
