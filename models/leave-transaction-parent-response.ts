 ...
 * 
 * @export
 * @interface LeaveTransactionParentResponse
 */
export interface LeaveTransactionParentResponse {
    /**
     * 
     * @type {string}
     * @memberof LeaveTransactionParentResponse
     */
    'id': string;
    /**
     * 
     ...
     * @memberof LeaveTransactionParentResponse
     */
    'type': LeaveTransactionParentResponseTypeEnum;
}

type LeaveTransactionParentResponseTypeEnum = 'Leave' | 'TimesheetEntry'
