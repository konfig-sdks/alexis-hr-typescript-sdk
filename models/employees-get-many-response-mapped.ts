...
import { EmployeeGetManyRelationsResponse } from './employee-get-many-relations-response';
import { EmployeeResponse } from './employee-response';

/**
 * 
 * @export
 * @interface EmployeesGetManyResponseMapped
 */
export interface EmployeesGetManyResponseMapped {
    /**
     * Status String
     * @type {string}
     * @memberof EmployeesGetManyResponseMapped
     */
    'status': string;
    /**
     * Resource data
    ...
    /**
     * Resource relations
     * @type {EmployeeGetManyRelationsResponse}
     * @memberof EmployeesGetManyResponseMapped
     */
    'relations'?: EmployeeGetManyRelationsResponse;
}
