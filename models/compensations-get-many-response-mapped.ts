 ...
 * 
 * @export
 * @interface CompensationsGetManyResponseMapped
 */
export interface CompensationsGetManyResponseMapped {
    /**
     * Status String
     * @type {string}
     * @memberof CompensationsGetManyResponseMapped
     */
    'status': string;
    /**
     * Resource data
     ...
     * @memberof CompensationsGetManyResponseMapped
     */
    'data': Array<CompensationResponse>;
    /**
