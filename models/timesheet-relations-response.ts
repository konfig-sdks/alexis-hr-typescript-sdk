 ...
 * 
 * @export
 * @interface TimesheetRelationsResponse
 */
export interface TimesheetRelationsResponse {
    /**
     * 
     * @type {Array<EmployeeResponse>}
     * @memberof TimesheetRelationsResponse
     */
    'approverEmployee'?: Array<EmployeeResponse>;
    /**
     * 
     * @type {Array<EmployeeResponse>}
     * @memberof TimesheetRelationsResponse
