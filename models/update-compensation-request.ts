 ...
 * 
 * @export
 * @interface UpdateCompensationRequest
 */
export interface UpdateCompensationRequest {
    /**
     * 
     * @type {string}
     * @memberof UpdateCompensationRequest
     */
    'employeeId'?: string;
    /**
     * 
     ...
     * @memberof UpdateCompensationRequest
     */
    'currency'?: UpdateCompensationRequestCurrencyEnum;
    /**
     * 
     * @type {number}
     * @memberof UpdateCompensationRequest
     ...
     * @memberof UpdateCompensationRequest
     */
    'payoutPeriod'?: UpdateCompensationRequestPayoutPeriodEnum;
    /**
     * 
     * @type {string}
     * @memberof UpdateCompensationRequest
     */
    'payoutFrequency'?: UpdateCompensationRequestPayoutFrequencyEnum;
    /**
     * 
     * @type {string}
     * @memberof UpdateCompensationRequest
     */
    'salarySchedule'?: UpdateCompensationRequestSalaryScheduleEnum;
    /**
     * 
     * @type {boolean}
     * @memberof UpdateCompensationRequest
