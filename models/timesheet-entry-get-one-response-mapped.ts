 ...
 * 
 * @export
 * @interface TimesheetEntryGetOneResponseMapped
 */
export interface TimesheetEntryGetOneResponseMapped {
    /**
     * Status String
     * @type {string}
     * @memberof TimesheetEntryGetOneResponseMapped
     */
    'status': string;
    /**
     * Resource data
     * @type {TimesheetEntryResponse}
     * @memberof TimesheetEntryGetOneResponseMapped
     */
    'data': TimesheetEntryResponse;
    /**
     * Resource relations
