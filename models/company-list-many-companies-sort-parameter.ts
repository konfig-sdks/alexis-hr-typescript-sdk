 ...
 * 
 * @export
 * @interface CompanyListManyCompaniesSortParameter
 */
export interface CompanyListManyCompaniesSortParameter {
    /**
     * 
     * @type {string}
     * @memberof CompanyListManyCompaniesSortParameter
     */
    'id'?: CompanyListManyCompaniesSortParameterIdEnum;
}

type CompanyListManyCompaniesSortParameterIdEnum = 'asc' | 'desc'
