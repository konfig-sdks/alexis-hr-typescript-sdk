 ...
 * 
 * @export
 * @interface TimesheetEntryTypeGetOneResponseMapped
 */
export interface TimesheetEntryTypeGetOneResponseMapped {
    /**
     * Status String
     * @type {string}
     * @memberof TimesheetEntryTypeGetOneResponseMapped
     */
    'status': string;
    /**
     * Resource data
     * @type {TimesheetEntryTypeResponse}
     * @memberof TimesheetEntryTypeGetOneResponseMapped
     */
    'data': TimesheetEntryTypeResponse;
    /**
     * 
     * @type {object}
     * @memberof TimesheetEntryTypeGetOneResponseMapped
