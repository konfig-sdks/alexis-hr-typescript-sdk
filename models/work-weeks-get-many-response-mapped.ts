...
import { WorkWeekRelationsResponse } from './work-week-relations-response';
import { WorkWeekResponse } from './work-week-response';

/**
 * 
 * @export
 * @interface WorkWeeksGetManyResponseMapped
 */
export interface WorkWeeksGetManyResponseMapped {
    /**
     * Status String
     * @type {string}
     * @memberof WorkWeeksGetManyResponseMapped
     */
    'status': string;
    /**
     * Resource data
     * @type {Array<WorkWeekResponse>}
     * @memberof WorkWeeksGetManyResponseMapped
     */
    'data': Array<WorkWeekResponse>;
    /**
    ...
    /**
     * Resource relations
     * @type {WorkWeekRelationsResponse}
     * @memberof WorkWeeksGetManyResponseMapped
     */
    'relations'?: WorkWeekRelationsResponse;
}
