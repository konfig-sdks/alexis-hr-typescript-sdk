...
import { CompensationResponse } from './compensation-response';
...
import { EmployeeTeamReferenceResponse } from './employee-team-reference-response';
import { EmploymentResponse } from './employment-response';
import { EmploymentTypeResponse } from './employment-type-response';
import { OfficeResponse } from './office-response';

/**
 * 
 * @export
 * @interface EmployeeGetManyRelationsResponse
 */
export interface EmployeeGetManyRelationsResponse {
    /**
     * 
     * @type {Array<OfficeResponse>}
     * @memberof EmployeeGetManyRelationsResponse
     */
    'office'?: Array<OfficeResponse>;
    /**
     * 
     * @type {Array<CostCenterResponse>}
     * @memberof EmployeeGetManyRelationsResponse
     */
    'costCenter'?: Array<CostCenterResponse>;
    /**
     * 
     * @type {Array<CostCenterResponse>}
     * @memberof EmployeeGetManyRelationsResponse
     */
    'effectiveCostCenter'?: Array<CostCenterResponse>;
    /**
     * 
     * @type {Array<ChildResponse>}
     * @memberof EmployeeGetManyRelationsResponse
     */
    'child'?: Array<ChildResponse>;
    /**
     * 
     * @type {Array<DepartmentResponse>}
     * @memberof EmployeeGetManyRelationsResponse
     */
    'department'?: Array<DepartmentResponse>;
    /**
     * 
     * @type {Array<EmergencyContactResponse>}
     * @memberof EmployeeGetManyRelationsResponse
     */
    'emergencyContact'?: Array<EmergencyContactResponse>;
    /**
     * 
     * @type {Array<EmploymentResponse>}
     * @memberof EmployeeGetManyRelationsResponse
     */
    'employment'?: Array<EmploymentResponse>;
    /**
     * 
     * @type {Array<EmploymentTypeResponse>}
     * @memberof EmployeeGetManyRelationsResponse
     */
    'employmentType'?: Array<EmploymentTypeResponse>;
    /**
     * 
     * @type {Array<CompensationResponse>}
     * @memberof EmployeeGetManyRelationsResponse
     */
    'compensation'?: Array<CompensationResponse>;
    /**
     * 
     * @type {Array<EmployeeResponse>}
     * @memberof EmployeeGetManyRelationsResponse
     */
    'managerEmployee'?: Array<EmployeeResponse>;
    /**
     * 
     * @type {Array<EmployeeTeamReferenceResponse>}
     * @memberof EmployeeGetManyRelationsResponse
     */
    'teamReference'?: Array<EmployeeTeamReferenceResponse>;
}
