 ...
 * 
 * @export
 * @interface TimesheetentrytypeListManyTimesheetEntryTypesSortParameter
 */
export interface TimesheetentrytypeListManyTimesheetEntryTypesSortParameter {
    /**
     * 
     * @type {string}
     * @memberof TimesheetentrytypeListManyTimesheetEntryTypesSortParameter
     */
    'id'?: TimesheetentrytypeListManyTimesheetEntryTypesSortParameterIdEnum;
    /**
     * 
     * @type {string}
     * @memberof TimesheetentrytypeListManyTimesheetEntryTypesSortParameter
     */
    'name'?: TimesheetentrytypeListManyTimesheetEntryTypesSortParameterNameEnum;
    /**
     * 
     * @type {string}
     * @memberof TimesheetentrytypeListManyTimesheetEntryTypesSortParameter
     */
    'kind'?: TimesheetentrytypeListManyTimesheetEntryTypesSortParameterKindEnum;
}

type TimesheetentrytypeListManyTimesheetEntryTypesSortParameterIdEnum = 'asc' | 'desc'
type TimesheetentrytypeListManyTimesheetEntryTypesSortParameterNameEnum = 'asc' | 'desc'
type TimesheetentrytypeListManyTimesheetEntryTypesSortParameterKindEnum = 'asc' | 'desc'
