...
export interface CompensationResponse {
     ...
     * @memberof CompensationResponse
     */
    'currency': CompensationResponseCurrencyEnum;
    /**
     * 
     * @type {number}
     * @memberof CompensationResponse
     ...
     * @memberof CompensationResponse
     */
    'payoutPeriod': CompensationResponsePayoutPeriodEnum;
    /**
     * 
     * @type {string}
     * @memberof CompensationResponse
     */
    'payoutFrequency': CompensationResponsePayoutFrequencyEnum;
    /**
     * 
     * @type {string}
     * @memberof CompensationResponse
     */
    'salarySchedule': CompensationResponseSalaryScheduleEnum;
    /**
     * 
     * @type {boolean}
     * @memberof CompensationResponse
