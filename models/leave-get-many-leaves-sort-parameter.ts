 ...
 * 
 * @export
 * @interface LeaveGetManyLeavesSortParameter
 */
export interface LeaveGetManyLeavesSortParameter {
    /**
     * 
     * @type {string}
     * @memberof LeaveGetManyLeavesSortParameter
     */
    'id'?: LeaveGetManyLeavesSortParameterIdEnum;
    /**
     * 
     * @type {string}
     * @memberof LeaveGetManyLeavesSortParameter
     */
    'employeeId'?: LeaveGetManyLeavesSortParameterEmployeeIdEnum;
    /**
     * 
     * @type {string}
     * @memberof LeaveGetManyLeavesSortParameter
     */
    'typeId'?: LeaveGetManyLeavesSortParameterTypeIdEnum;
    /**
     * 
     * @type {string}
     * @memberof LeaveGetManyLeavesSortParameter
     */
    'status'?: LeaveGetManyLeavesSortParameterStatusEnum;
    /**
     * 
     * @type {string}
     * @memberof LeaveGetManyLeavesSortParameter
     */
    'duration'?: LeaveGetManyLeavesSortParameterDurationEnum;
    /**
     * 
     * @type {string}
     * @memberof LeaveGetManyLeavesSortParameter
     */
    'startDate'?: LeaveGetManyLeavesSortParameterStartDateEnum;
    /**
     * 
     * @type {string}
     * @memberof LeaveGetManyLeavesSortParameter
     */
    'endDate'?: LeaveGetManyLeavesSortParameterEndDateEnum;
}

type LeaveGetManyLeavesSortParameterIdEnum = 'asc' | 'desc'
type LeaveGetManyLeavesSortParameterEmployeeIdEnum = 'asc' | 'desc'
type LeaveGetManyLeavesSortParameterTypeIdEnum = 'asc' | 'desc'
type LeaveGetManyLeavesSortParameterStatusEnum = 'asc' | 'desc'
type LeaveGetManyLeavesSortParameterDurationEnum = 'asc' | 'desc'
type LeaveGetManyLeavesSortParameterStartDateEnum = 'asc' | 'desc'
type LeaveGetManyLeavesSortParameterEndDateEnum = 'asc' | 'desc'
