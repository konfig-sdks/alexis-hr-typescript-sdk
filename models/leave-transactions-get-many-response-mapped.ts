...
import { LeaveTransactionRelationsResponse } from './leave-transaction-relations-response';
import { LeaveTransactionResponse } from './leave-transaction-response';

/**
 * 
 * @export
 * @interface LeaveTransactionsGetManyResponseMapped
 */
export interface LeaveTransactionsGetManyResponseMapped {
    /**
     * Status String
     * @type {string}
     * @memberof LeaveTransactionsGetManyResponseMapped
     */
    'status': string;
    /**
     * Resource data
     * @type {Array<LeaveTransactionResponse>}
     * @memberof LeaveTransactionsGetManyResponseMapped
     */
    'data': Array<LeaveTransactionResponse>;
    /**
    ...
    /**
     * Resource relations
     * @type {LeaveTransactionRelationsResponse}
     * @memberof LeaveTransactionsGetManyResponseMapped
     */
    'relations'?: LeaveTransactionRelationsResponse;
}
