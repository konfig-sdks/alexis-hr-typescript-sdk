...
import { DepartmentRelationsResponse } from './department-relations-response';
import { DepartmentResponse } from './department-response';

/**
 * 
 * @export
 * @interface DepartmentsGetManyResponseMapped
 */
export interface DepartmentsGetManyResponseMapped {
    /**
     * Status String
     * @type {string}
     * @memberof DepartmentsGetManyResponseMapped
     */
    'status': string;
    /**
     * Resource data
    ...
    /**
     * Resource relations
     * @type {DepartmentRelationsResponse}
     * @memberof DepartmentsGetManyResponseMapped
     */
    'relations'?: DepartmentRelationsResponse;
}
