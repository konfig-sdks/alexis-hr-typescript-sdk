 ...
 * 
 * @export
 * @interface EmployeeTeamReferenceGetOneResponseMapped
 */
export interface EmployeeTeamReferenceGetOneResponseMapped {
    /**
     * Status String
     * @type {string}
     * @memberof EmployeeTeamReferenceGetOneResponseMapped
     */
    'status': string;
    /**
     * Resource data
     * @type {EmployeeTeamReferenceResponse}
     * @memberof EmployeeTeamReferenceGetOneResponseMapped
     */
    'data': EmployeeTeamReferenceResponse;
    /**
     * Resource relations
