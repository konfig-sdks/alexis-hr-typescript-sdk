 ...
 * 
 * @export
 * @interface EmploymentTypesGetManyResponseMapped
 */
export interface EmploymentTypesGetManyResponseMapped {
    /**
     * Status String
     * @type {string}
     * @memberof EmploymentTypesGetManyResponseMapped
     */
    'status': string;
    /**
     * Resource data
     ...
     * @memberof EmploymentTypesGetManyResponseMapped
     */
    'data': Array<EmploymentTypeResponse>;
    /**
