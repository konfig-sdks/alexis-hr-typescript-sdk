...
import { LeaveTypeGetOneRelationResponse } from './leave-type-get-one-relation-response';
import { LeaveTypeResponse } from './leave-type-response';

/**
 * 
 * @export
 * @interface LeaveTypeGetOneResponseMapped
 */
export interface LeaveTypeGetOneResponseMapped {
    /**
     * Status String
     * @type {string}
     * @memberof LeaveTypeGetOneResponseMapped
     */
    'status': string;
    /**
     * Resource data
    ...
    /**
     * Resource relations
     * @type {LeaveTypeGetOneRelationResponse}
     * @memberof LeaveTypeGetOneResponseMapped
     */
    'relations'?: LeaveTypeGetOneRelationResponse;
}
