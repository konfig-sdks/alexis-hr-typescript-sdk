 ...
 * 
 * @export
 * @interface WorkweekGetManySortParameter
 */
export interface WorkweekGetManySortParameter {
    /**
     * 
     * @type {string}
     * @memberof WorkweekGetManySortParameter
     */
    'id'?: WorkweekGetManySortParameterIdEnum;
    /**
     * 
     * @type {string}
     * @memberof WorkweekGetManySortParameter
     */
    'companyId'?: WorkweekGetManySortParameterCompanyIdEnum;
    /**
     * 
     * @type {string}
     * @memberof WorkweekGetManySortParameter
     */
    'officeId'?: WorkweekGetManySortParameterOfficeIdEnum;
    /**
     * 
     * @type {string}
     * @memberof WorkweekGetManySortParameter
     */
    'employeeId'?: WorkweekGetManySortParameterEmployeeIdEnum;
    /**
     * 
     * @type {string}
     * @memberof WorkweekGetManySortParameter
     */
    'effectiveFrom'?: WorkweekGetManySortParameterEffectiveFromEnum;
    /**
     * 
     * @type {string}
     * @memberof WorkweekGetManySortParameter
     */
    'timezone'?: WorkweekGetManySortParameterTimezoneEnum;
    /**
     * 
     * @type {string}
     * @memberof WorkweekGetManySortParameter
     */
    'duration'?: WorkweekGetManySortParameterDurationEnum;
}

type WorkweekGetManySortParameterIdEnum = 'asc' | 'desc'
type WorkweekGetManySortParameterCompanyIdEnum = 'asc' | 'desc'
type WorkweekGetManySortParameterOfficeIdEnum = 'asc' | 'desc'
type WorkweekGetManySortParameterEmployeeIdEnum = 'asc' | 'desc'
type WorkweekGetManySortParameterEffectiveFromEnum = 'asc' | 'desc'
type WorkweekGetManySortParameterTimezoneEnum = 'asc' | 'desc'
type WorkweekGetManySortParameterDurationEnum = 'asc' | 'desc'
