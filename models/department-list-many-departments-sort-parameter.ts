 ...
 * 
 * @export
 * @interface DepartmentListManyDepartmentsSortParameter
 */
export interface DepartmentListManyDepartmentsSortParameter {
    /**
     * 
     * @type {string}
     * @memberof DepartmentListManyDepartmentsSortParameter
     */
    'id'?: DepartmentListManyDepartmentsSortParameterIdEnum;
    /**
     * 
     * @type {string}
     * @memberof DepartmentListManyDepartmentsSortParameter
     */
    'companyId'?: DepartmentListManyDepartmentsSortParameterCompanyIdEnum;
    /**
     * 
     * @type {string}
     * @memberof DepartmentListManyDepartmentsSortParameter
     */
    'name'?: DepartmentListManyDepartmentsSortParameterNameEnum;
    /**
     * 
     * @type {string}
     * @memberof DepartmentListManyDepartmentsSortParameter
     */
    'costCenterId'?: DepartmentListManyDepartmentsSortParameterCostCenterIdEnum;
    /**
     * 
     * @type {string}
     * @memberof DepartmentListManyDepartmentsSortParameter
     */
    'effectiveCostCenterId'?: DepartmentListManyDepartmentsSortParameterEffectiveCostCenterIdEnum;
    /**
     * 
     * @type {string}
     * @memberof DepartmentListManyDepartmentsSortParameter
     */
    'parentId'?: DepartmentListManyDepartmentsSortParameterParentIdEnum;
}

type DepartmentListManyDepartmentsSortParameterIdEnum = 'asc' | 'desc'
type DepartmentListManyDepartmentsSortParameterCompanyIdEnum = 'asc' | 'desc'
type DepartmentListManyDepartmentsSortParameterNameEnum = 'asc' | 'desc'
type DepartmentListManyDepartmentsSortParameterCostCenterIdEnum = 'asc' | 'desc'
type DepartmentListManyDepartmentsSortParameterEffectiveCostCenterIdEnum = 'asc' | 'desc'
type DepartmentListManyDepartmentsSortParameterParentIdEnum = 'asc' | 'desc'
