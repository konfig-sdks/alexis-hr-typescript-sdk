 ...
 * 
 * @export
 * @interface CostcenterGetManySortParameter
 */
export interface CostcenterGetManySortParameter {
    /**
     * 
     * @type {string}
     * @memberof CostcenterGetManySortParameter
     */
    'id'?: CostcenterGetManySortParameterIdEnum;
    /**
     * 
     * @type {string}
     * @memberof CostcenterGetManySortParameter
     */
    'companyId'?: CostcenterGetManySortParameterCompanyIdEnum;
    /**
     * 
     * @type {string}
     * @memberof CostcenterGetManySortParameter
     */
    'code'?: CostcenterGetManySortParameterCodeEnum;
    /**
     * 
     * @type {string}
     * @memberof CostcenterGetManySortParameter
     */
    'name'?: CostcenterGetManySortParameterNameEnum;
}

type CostcenterGetManySortParameterIdEnum = 'asc' | 'desc'
type CostcenterGetManySortParameterCompanyIdEnum = 'asc' | 'desc'
type CostcenterGetManySortParameterCodeEnum = 'asc' | 'desc'
type CostcenterGetManySortParameterNameEnum = 'asc' | 'desc'
