...
import { WorkWeekDayResponse } from './work-week-day-response';

/**
 * 
 * @export
 * @interface WorkWeekResponse
 */
export interface WorkWeekResponse {
    /**
     * 
     * @type {string}
     * @memberof WorkWeekResponse
     */
    'id': string;
    /**
     * 
    ...
    /**
     * 
     * @type {WorkWeekDayResponse}
     * @memberof WorkWeekResponse
     */
    'monday': WorkWeekDayResponse;
    /**
     * 
     * @type {WorkWeekDayResponse}
     * @memberof WorkWeekResponse
     */
    'tuesday': WorkWeekDayResponse;
    /**
     * 
     * @type {WorkWeekDayResponse}
     * @memberof WorkWeekResponse
     */
    'wednesday': WorkWeekDayResponse;
    /**
     * 
     * @type {WorkWeekDayResponse}
     * @memberof WorkWeekResponse
     */
    'thursday': WorkWeekDayResponse;
    /**
     * 
     * @type {WorkWeekDayResponse}
     * @memberof WorkWeekResponse
     */
    'friday': WorkWeekDayResponse;
    /**
     * 
     * @type {WorkWeekDayResponse}
     * @memberof WorkWeekResponse
     */
    'saturday': WorkWeekDayResponse;
    /**
     * 
     * @type {WorkWeekDayResponse}
     * @memberof WorkWeekResponse
     */
    'sunday': WorkWeekDayResponse;
}
