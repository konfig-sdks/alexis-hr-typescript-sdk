 ...
 * 
 * @export
 * @interface CostCentersGetManyResponseMapped
 */
export interface CostCentersGetManyResponseMapped {
    /**
     * Status String
     * @type {string}
     * @memberof CostCentersGetManyResponseMapped
     */
    'status': string;
    /**
     * Resource data
