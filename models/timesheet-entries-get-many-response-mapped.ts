...
import { TimesheetEntryRelationsResponse } from './timesheet-entry-relations-response';
import { TimesheetEntryResponse } from './timesheet-entry-response';

/**
 * 
 * @export
 * @interface TimesheetEntriesGetManyResponseMapped
 */
export interface TimesheetEntriesGetManyResponseMapped {
    /**
     * Status String
     * @type {string}
     * @memberof TimesheetEntriesGetManyResponseMapped
     */
    'status': string;
    /**
     * Resource data
     * @type {Array<TimesheetEntryResponse>}
     * @memberof TimesheetEntriesGetManyResponseMapped
     */
    'data': Array<TimesheetEntryResponse>;
    /**
    ...
    /**
     * Resource relations
     * @type {TimesheetEntryRelationsResponse}
     * @memberof TimesheetEntriesGetManyResponseMapped
     */
    'relations'?: TimesheetEntryRelationsResponse;
}
